package com.github.muran2.idea.git;

import com.github.muran2.idea.gitlab.quickmr.SelectedModule;
...
public class GitService {
    private static final Logger LOG = Logger.getInstance("#com.github.muran2.idea.git.GitService");
